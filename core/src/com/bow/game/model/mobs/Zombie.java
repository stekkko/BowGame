...
public class Zombie extends Enemy {
    ...
    public Zombie(float x, float y, float width, float height, float maxHealthPoints, float damage, float repelPower, Random random) {
        super(textures[0][0], x, y, width, height, maxHealthPoints, damage, repelPower, 5, true);
